...
exports.EnttecOpenDMXUSB = void 0;
...
class EnttecOpenDMXUSB {
    ...
    constructor() {
        ...
        this.dmxHexString = (0, utils_1.emptyDmxHexString)();
        this.initSequenceSent = false;
        this.mainLoop();
        this.updateDispatch = () => { };
    }
    static getInstance() {
        if (!EnttecOpenDMXUSB.instance) {
            EnttecOpenDMXUSB.instance = new EnttecOpenDMXUSB();
        }
        return EnttecOpenDMXUSB.instance;
    }
    state = () => {
    ...
    connect = async () => {
        ...
        const endpointOut = interfaceConfiguration.endpoints.filter((endpoint) => endpoint.direction == 'out')[0];
    ...
    sendValue = async () => {
        ...
        try {
            ...
            const arrayBuffer = (0, utils_1.dmxHexToArrayBuffer)(this.dmxHexString);
            //console.log(arrayBuffer)
            await this.device.transferOut(this.endpointNumber, arrayBuffer);
        }
        catch (error) {
            this.device = undefined;
...
exports.EnttecOpenDMXUSB = EnttecOpenDMXUSB;
//# sourceMappingURL=enttec_open_dmx_usb.js.map